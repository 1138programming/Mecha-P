...
public class Flywheel extends Subsystem
{
	...
	// For now, these speeds are unified for all the motors in the subsystem until
	// they need to be separate speeds.
	...
	private final TalonSRX topFlywheelMotor, bottomFlywheelMotor, angleAdjusterFlywheelMotor, indexerFlywheelMotor;
	...
	public Flywheel()
	{
		...
		bottomFlywheelMotor.set(ControlMode.Follower, topFlywheelMotor.getDeviceID());
	}
